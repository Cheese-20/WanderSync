...
- **Backend / Feature**: Integrated notifications into the core workflows. `MessageController.cs` now triggers a "NewMessage" notification, and `ProfileController.cs` triggers "MatchRequest" and "MatchAccepted" notifications dynamically.
