    ...
    try
    {
        ...
        try {
            ...
            var insertDummyToursSql = @"
                ...
                (9101, 21, 'Route 67 Walking Tour', 'Cultural', 'Discover the 67 public art works symbolising Nelson Mandela''s 67 years of work dedicated to the freedom of South Africa.', '2026-09-10 10:00:00', 15, 150.00, 'Gqeberha', 'https://images.unsplash.com/photo-1547471080-7bc2caa7eaa3?w=600'),
                (9102, 21, 'Donkin Heritage Trail', 'History', 'Walk the 5km trail that links 51 places of historical interest in the old Hill area of Port Elizabeth.', '2026-09-15 09:00:00', 20, 100.00, 'Gqeberha', 'https://images.unsplash.com/photo-1518342797664-9f93ee74f261?w=600'),
                (9103, 21, 'Sardinia Bay Beach Hike', 'Nature', 'Enjoy a guided hike along the pristine coastline of Sardinia Bay, known for its miles of unspoiled beach and towering sand dunes.', '2026-09-18 07:30:00', 10, 200.00, 'Gqeberha', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600'),
                (9104, 21, 'Kragga Kamma Game Park Safari', 'Wildlife', 'Experience close encounters with white rhino, buffalo, cheetah, giraffe, zebra, and various antelope species in a lush coastal forest setting.', '2026-09-22 14:00:00', 8, 450.00, 'Gqeberha', 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=600'),
                (9105, 21, 'Addo Elephant National Park Trip', 'Wildlife', 'A full-day guided trip to Addo, home to over 600 elephants, lions, buffalo, black rhino, and leopard.', '2026-09-25 08:00:00', 12, 1200.00, 'Gqeberha', 'https://images.unsplash.com/photo-1588523315783-65391d3780f2?w=600'),
                (9106, 21, 'Boardwalk Casino and Entertainment Tour', 'Leisure', 'An evening tour of the Boardwalk precinct, featuring dining, shopping, and the spectacular musical fountain show.', '2026-09-30 18:00:00', 25, 300.00, 'Gqeberha', 'https://images.unsplash.com/photo-1549490349-8643362247b5?w=600'),
                (9107, 21, 'Algoa Bay Boat Cruise', 'Adventure', 'Take a boat cruise into Algoa Bay to spot dolphins, whales (in season), seals, and penguins at St Croix Island.', '2026-10-05 09:00:00', 15, 850.00, 'Gqeberha', 'https://images.unsplash.com/photo-1563220465-728b7e64177f?w=600');
            ";
            context.Database.ExecuteSqlRaw(insertDummyToursSql);
            Console.WriteLine("SUCCESS: Inserted 12 dummy tours (or skipped if already exist)");
        } catch (Exception e) {
